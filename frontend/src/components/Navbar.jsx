...
function Navbar() {
  ...
  return (
    <>
      <div className= {`max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
        sticky
        ? "sticky-navbar shadow-md bg-base-200 duration-200 dark:bg-slate-600 dark:text-white  transition-all ease-in-out"
        :""
      }`}>
        <div className="navbar">
          ...
          <div className="navbar-end flex items-center">
            {/* search button */}
            <label className="px-3 py-2 border rounded-md flex items-center gap-2 mr-10">
  ...
  {/* sun icon */}
  <svg
    className="swap-off h-6 w-6 fill-current mr-8"
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    onClick={
  ...
  {/* moon icon */}
  <svg
    className="swap-on h-5 w-5 fill-current space-x-3 "
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    onClick={
